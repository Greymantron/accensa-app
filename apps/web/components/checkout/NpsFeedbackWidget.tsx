...
export const NpsFeedbackWidget: React.FC<NpsFeedbackWidgetProps> = ({ transactionId, merchantId }) => {
      ...
      <div className="p-4 relative">
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit}>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">How was your payment experience?</h3>
